        ...
        <div className='h-screen bg-gray-100 flex flex-col'>
            ...
            <div className='bg-white shadow-md px-4 py-4 flex items-center justify-between z-10'>
                <div className='flex items-center gap-4'>
                    <Link to='/home' className='w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200 transition-colors'>
            ...
            <div className='flex-1 overflow-y-auto p-4'>
                {loading ? (
                    ...
                    <div className='text-center mt-20'>
                        <i className="ri-road-map-line text-6xl text-gray-300"></i>
                        <p className='text-gray-500 mt-4 text-lg'>You haven't taken any trips yet.</p>
                    </div>
                ) : (
                    <div className='space-y-4'>
                        {trips.map((trip) => (
                            <div key={trip._id} className='bg-white rounded-2xl p-5 shadow-sm border border-gray-100 hover:shadow-md transition-shadow'>
                                ...
                                {trip.captain && trip.status === 'completed' && (
                                    <div className='mt-4 pt-4 border-t border-gray-100 flex items-center gap-3'>
                                        <div className='w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center overflow-hidden'>
                                            <i className="ri-user-3-fill text-gray-400 text-xl"></i>
                                        </div>
                                        <div>
                                            <p className='text-sm font-medium'>Driven by {trip.captain.fullname.firstname}</p>
